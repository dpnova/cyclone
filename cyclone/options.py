...
Each module defines its own options, e.g.::
    ...
    from cyclone.options import define, options
...
or parse a config file with::
    ...
    cyclone.options.parse_config_file("/etc/server.conf")
...
from cyclone.escape import _unicode
...
class _Options(dict):
    ...
    Normally accessed via static functions in the `cyclone.options` module,
